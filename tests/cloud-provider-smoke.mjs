...
assert.match(kiraService, /DIRECTOR_MODEL = 'gpt-5\.4'/);
...
assert.match(kiraService, /forceCreativeRebuild/);
...
assert.match(kiraUi, /GPT-5\.4 Director/);
assert.match(kiraUi, /forceKiraCreativeRebuild/);
...
console.log('Cloud provider smoke test passed for Krea and Kira GPT-5.4 AI Director wiring.');