...
assert.match(kiraService, /analyzeReferenceImage/);
assert.match(kiraService, /parseAnalysisJson/);
assert.match(kiraService, /buildReconstructionPrompt/);
assert.match(kiraService, /image_type/);
assert.match(kiraService, /details_to_improve/);
assert.match(kiraService, /elements_to_preserve/);
assert.match(kiraService, /kira-3\.5-flash/);
assert.match(kiraService, /image_url/);
assert.match(kiraService, /b64_json/);
assert.match(kiraService, /sourceAnalyzedByVision: true/);
assert.match(kiraService, /promptBuiltInternally: true/);
...
assert.match(kiraUi, /AI Rebuild/);
assert.match(kiraUi, /providerState\.models/);
assert.match(kiraUi, /rebuildMode/);
assert.match(kiraUi, /Yêu cầu bổ sung · tùy chọn/);
assert.match(kiraUi, /prompt tự động/);
...
console.log('Cloud provider smoke test passed for Krea and structured Kira AI Rebuild wiring.');